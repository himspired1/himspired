                    ...
                    <div className="min-h-screen top-24 relative px-6 md:px-14 pb-52">
                        <div className="w-full flex items-center justify-between">
                            ...
                            <div className="text-right">
                                ...
                                <P className="text-lg font-bold">Total: ₦{(cartTotal + 1000).toLocaleString()}</P>
                            </div>
                        </div>
                        ...
                        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                            ...
                            >
                                ...
                                <P className="text-sm text-gray-600">
                                    ...
                                    {uploadProgress >= 30 && uploadProgress < 60 && "Uploading payment receipt..."}
                                    {uploadProgress >= 60 && uploadProgress < 90 && "Saving to database..."}
